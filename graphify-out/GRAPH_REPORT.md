...
## Corpus Check
- 498 files · ~1,057,545 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3781 nodes · 8642 edges · 240 communities (212 shown, 28 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 216 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `74accde4`
...
- recharts
- dermatologist/follow-ups/page.tsx
- dermatologist/progress/page.tsx
- dermatologist/reminders/page.tsx
- treatment-plans/page.tsx
- dermatologist/treatment-protocols/page.tsx
- .__call__
- tailwind-merge
- test_rate_limit.py
- .__call__
...
### Community 0 - "get_db"
Cohesion: 0.07
Nodes (93): require_role(), get_db(), AsyncSession, approve_verification(), assign_consultant_client(), create_audit_log(), deactivate_professional(), get_audit_logs() (+85 more)

### Community 1 - "require_user"
Cohesion: 0.10
Nodes (30): ClinicalDashboardProps, RosterColumn, RosterTable(), RosterTableProps, Table(), TableBody(), TableCaption(), TableCell() (+22 more)
...
Cohesion: 0.06
Nodes (44): LatencyStatsRead, ASSIGNABLE_ROLES, BetterAuthUser, ListUsersResponse, Role, QueueItem, ROLE_OPTIONS, STATUS_OPTIONS (+36 more)

### Community 4 - "call_with_resilience"
Cohesion: 0.13
Nodes (26): AdapterError, call_with_resilience(), CircuitBreaker, Exception, Raised once an adapter's resilience policy (retries + circuit breaker) is     e, Opens after `failure_threshold` consecutive failures; half-open (one probe, 10 s timeout · 3 retries, exponential backoff + jitter · circuit breaker —, fetch_uv_index() (+18 more)
...
Cohesion: 0.09
Nodes (56): Polymorphic across ConsultantProfile/DermatologistProfile via `owner_user_id`,, VerificationDocument, apply_verification_action(), assign_client(), create_document(), delete_document(), get_document_view_url(), _get_for_model() (+48 more)
...
### Community 8 - "Base"
Cohesion: 0.10
Nodes (47): Product, ProductIngredient, ProductRecommendation, No DDL change (M3-D, milestone_3.md §5) — this is simply the table's first, evaluate_products_suitability(), _get_budget_preference(), get_products_by_ids(), get_recommendations() (+39 more)
...
Cohesion: 0.11
Nodes (28): GlassTopbarProps, NavUserProps, NAV_LINKS, ThemeToggle(), Avatar(), AvatarBadge(), AvatarFallback(), AvatarGroup() (+20 more)

### Community 14 - "test_routines_service.py"
Cohesion: 0.15
Nodes (47): _am_pm_categories_for_skin_type(), get_or_generate_routines(), ProductRead, Deterministic, `hash(user_id)`-seeded routine generation (ADR-007 spirit) — no, search_products_for_edit(), Taxonomy/reference table — seeded, rarely written after (Normal/Dry/Oily/     C, SkinType, SkinProfileCreate (+39 more)
...
Cohesion: 0.06
Nodes (64): toggle_step_completion(), ScoringWeights, SkinScore, BaseModel, ScoreRead, ScoreWeightsRead, calculate_skin_health_score(), _hydration_score() (+56 more)
...
Cohesion: 0.06
Nodes (40): AssessmentBasicsPage(), GOALS, firstOf(), ProgressPage(), RANGES, SkinScoreTrendChart, ALCOHOL_ITEMS, emptyForm (+32 more)

### Community 19 - "signup/page.tsx"
Cohesion: 0.06
Nodes (52): CATEGORIES, VERDICT_LABEL, VERDICT_STYLE, InsightsPage(), AuthSplitLayout(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+44 more)
...
Cohesion: 0.12
Nodes (38): EnvironmentalExposure, LifestyleLogCreate, BaseModel, SkinConcernRead, SkinProfileConcernInput, SkinProfileConcernRead, SkinProfileRead, SkinTypeRead (+30 more)

### Community 22 - "postgres.py"
Cohesion: 0.10
Nodes (30): Validate, never authenticate — Better Auth is the auth authority (ADR-002/003)., Base, Shared declarative base. Each service owns its own tables (ADR-005) — a service, do_run_migrations(), include_object(), Any, In this scenario we need to create an Engine     and associate a connection wit, Run migrations in 'online' mode. (+22 more)
...
Cohesion: 0.09
Nodes (26): ADR-0005, CORE_TABS, MyRoutinePage(), RoutineRead, RoutineStepCard(), RoutineStepRead, RoutineType, RoutineChecklistCard() (+18 more)
...
Cohesion: 0.16
Nodes (22): ADR-0012, ADR-0023, signInAsAdmin(), ADR-0023, signIn(), signUpAndLand(), signIn(), signUp() (+14 more)

### Community 41 - "chart.tsx"
Cohesion: 0.07
Nodes (39): ALLERGY_OPTIONS, AssessmentLifestylePage(), firstOf(), SLEEP_QUALITY_ITEMS, SLEEP_QUALITY_OPTIONS, STRESS_LABELS, SUN_EXPOSURE_OPTIONS, CATEGORIES (+31 more)
...
Cohesion: 0.11
Nodes (34): AsyncElasticsearch, get_elasticsearch(), is_elasticsearch_available(), Lazy client — nothing connects until the first real call. Only     app/worker/, Absent-safe health check — callers fall back to a documented degraded path, build_article_document(), build_ingredient_document(), build_product_document() (+26 more)

### Community 44 - "assessment/context.tsx"
Cohesion: 0.08
Nodes (33): ACTIVE_VARIANT_CLASSES, AppSidebar(), AppSidebarProps, Sidebar(), SidebarContent(), SidebarContext, SidebarContextProps, SidebarFooter() (+25 more)
...
Cohesion: 0.06
Nodes (74): BaseModel, date, Every field here is a real, computed claim, same discipline as     `Suitability, TrendInsight, date, Deterministic linear-trend (ordinary least squares) over the series' values, RealProgressTrendAnalyzer, ProgressImage (+66 more)
...
Cohesion: 0.22
Nodes (8): LoginForm(), safeRedirectTarget(), AppShell(), AppShellProps, authClient, Role, ROLE_HOME, CurrentUser
...
Cohesion: 0.08
Nodes (25): ADR-001 — Drop the runtime graph database, ADR-002 — Better Auth is the single auth authority, ADR-003 — User IDs are strings (TEXT); identity tables are Better-Auth-owned, ADR-004 — Frontend: Next.js + Tailwind + shadcn/ui, Recharts, Stitch designs, ADR-005 — Modular monolith for M1–M3, containers at M4, ADR-006 — Adopt Graphify (the dev tool) for agent context persistence, ADR-007 — AI is stubbed until Milestone 2, ADR-008 — "Frosted Lab Glass" design language (glassmorphism on navy/blue/teal) (+17 more)
...
Cohesion: 0.15
Nodes (9): REQUIREMENTS, REQUIREMENTS, OnboardingShell(), OnboardingShellProps, STEPS, OnboardingShell(), OnboardingShellProps, STEPS (+1 more)
...
Cohesion: 0.24
Nodes (11): _IngredientSeed, main(), _ProductSeed, TypedDict, Idempotent local/dev seed data — `make seed` / `python -m app.db.seed`.  Seeds, seed_ingredients(), seed_products(), IngredientConcernTreats (+3 more)
...
Cohesion: 0.13
Nodes (16): ROLE_CARDS, SignupPage(), STRENGTH_COLORS, GoogleIcon(), FieldDescription(), FieldLegend(), forgotPasswordSchema, ForgotPasswordValues (+8 more)
...
Cohesion: 0.14
Nodes (19): ConsultantBackgroundPage(), ConsultantContactPage(), ConsultantPracticePage(), ConsultantReviewPage(), FIELD_LABELS, formatValue(), SUMMARY_SECTIONS, FieldError() (+11 more)
...
Cohesion: 0.14
Nodes (18): DermatologistBackgroundPage(), DermatologistContactPage(), DermatologistPracticePage(), DermatologistReviewPage(), FIELD_LABELS, formatValue(), SUMMARY_SECTIONS, TagInput() (+10 more)
...
Cohesion: 0.15
Nodes (12): ADR-0022, FooterConfig, NAV_SECTIONS, NavItem, NavSection, RAW_NAV, RawNavItem, RawNavSection (+4 more)
...
Cohesion: 0.21
Nodes (11): GlassTopbar(), NavUser(), FinalCtaSection(), HeroSection(), LandingNavbar(), Coords, useBrowserCoords(), useWeatherUV() (+3 more)
...
Cohesion: 0.28
Nodes (7): Field(), FieldContent(), FieldSeparator(), FieldSet(), FieldTitle(), fieldVariants, Separator()

### Community 208 - "conditions-guide/page.tsx"
Cohesion: 0.28
Nodes (8): Action, ACTION_LABELS, FIELD_LABELS, formatValue(), REASON_REQUIRED, Role, VerificationReviewPage(), FieldLabel()

### Community 210 - "dermatologist/follow-ups/page.tsx"
Cohesion: 0.40
Nodes (4): get_settings(), Env vars documented in /.env.example — read from there, not invented here., Settings, BaseSettings

### Community 212 - "dermatologist/progress/page.tsx"
Cohesion: 0.47
...
### Community 217 - "dermatologist/treatment-protocols/page.tsx"
Cohesion: 0.50
...
## Knowledge Gaps
- **1038 isolated node(s):** `WorkerSettings`, `skinlytics-backend`, `verification`, `jwks`, `outbox` (+1033 more)
...
- **Why does `cn()` connect `signup/page.tsx` to `require_user`, `button.tsx`, `progress/page.tsx`, `tailwind-merge`, `security.py`, `chart.tsx`, `appearance-settings.tsx`, `consultant/progress/page.tsx`, `test_dermatologist_profile_service.py`, `sidebar.tsx`, `consultant/dashboard/page.tsx`, `assessment/context.tsx`, `conditions-guide/page.tsx`, `consultant/follow-ups/page.tsx`, `utils.ts`, `get_mongo_db`, `routine/page.tsx`, `consultant-onboarding.ts`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `get_mongo_db()` connect `dermatologist/dashboard/page.tsx` to `ingredients/service.py`, `cn`, `Base`, `get_elasticsearch`, `test_routines_service.py`, `test_scores_service.py`, `test_skin_profile_service.py`, `vector.py`, `routines/service.py`, `(user)/dashboard/page.tsx`, `consultant_profile/router.py`, `app/main.py`, `field.tsx`, `StubTextEmbedder`, `product-recommendation-card.tsx`, `dermatologist/progress/page.tsx`, `class-variance-authority`, `test_progress_router.py`, `run_suitability_eval`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `get_db()` connect `get_db` to `test_consultant_profile_service.py`, `ingredients/service.py`, `(user)/dashboard/page.tsx`, `test_clinical_review_service.py`, `dermatologist-onboarding/onboarding-shell.tsx`, `cn`, `test_scores_service.py`, `field.tsx`, `postgres.py`, `nav-config.ts`?**
