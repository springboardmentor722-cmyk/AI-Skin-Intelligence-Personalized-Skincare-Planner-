...
# Known synonym/alias mappings to standard chemical active categories
ACTIVE_CATEGORY_MAP = {
    "retinoid": "Retinoids",
    "retinol": "Retinoids",
...
class INCIParserEngine:
    ...
    def tokenize_inci(raw_inci_string: str) -> List[str]:
        ...
        # Replace slashes in dual names like Water/Aqua/Eau with commas
        cleaned = re.sub(r'/(?=[A-Za-z])', ', ', raw_inci_string)
        # Remove percentage brackets e.g. (2%) or [5%]
    ...
    def parse(cls, raw_inci_string: str) -> Dict[str, Any]:
        ...
        for token in normalized_tokens:
            ...
            # Match fragrance/chemical filter allergens
