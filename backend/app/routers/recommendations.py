...
def get_my_recommendations(
    ...
    # Generate 128D User Vector Embedding
    ...
    for prod in products:
        ...
        # Stage 3 (Safety Gate): Allergies & Sensitivities (Hard Filter)
        ...
        # Stage 3 (Safety Gate): Chemical Conflict Matrix (Hard Filter)
        ...
        # Stage 2: Multi-Factor Refined Suitability Score
