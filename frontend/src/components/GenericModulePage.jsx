...
import { Box, Typography, Paper, Stack, Breadcrumbs, InputBase, Button, Chip, Divider, Avatar, IconButton } from "@mui/material";
...
export default function GenericModulePage({ title, description, parentModule = "Dashboard", primaryAction = "Create New" }) {
