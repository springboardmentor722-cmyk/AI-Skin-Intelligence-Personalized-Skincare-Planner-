...
// docs/DESIGN.md §9: "Inputs. Full pill-shape (v3)." Focus state uses a Royal Blue
// border + a subtle 2px outer glow, not a soft/diffuse blur — the ring here is 0-blur.
