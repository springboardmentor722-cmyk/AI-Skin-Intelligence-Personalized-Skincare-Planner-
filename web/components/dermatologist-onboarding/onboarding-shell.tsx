...
const STEPS = [
  { path: "/dermatologist-onboarding/background", label: "Background" },
  { path: "/dermatologist-onboarding/practice", label: "Practice" },
  { path: "/dermatologist-onboarding/contact", label: "Contact" },
  { path: "/dermatologist-onboarding/review", label: "Review" },
];
...
// Same chrome shape as components/consultant-onboarding/onboarding-shell.tsx — sticky
// glass progress header + step chips, sticky glass Back/Continue footer, no app-shell
// sidebar (this wizard runs before a dermatologist has anywhere to put one).
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <span className="font-geist text-on-surface-variant text-xs font-semibold tracking-[0.05em] uppercase">
              {step ? `Step ${step} of ${STEPS.length}` : "Dermatologist application"}
            </span>
          </div>
          {step != null && (
            <>
