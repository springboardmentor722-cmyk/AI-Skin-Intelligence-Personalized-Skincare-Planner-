...
// Same roster + ClientListTable as Clients/Assessments/Progress — pick a
// client, then generate/view their PDF reports.
export default function ConsultantReportsPage() {
  ...
  const clientsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      if (error) throw new Error("Couldn't load clients.");
      return data;
    },
  });
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-on-surface-variant mt-1 font-sans text-sm">Client reports & analytics.</p>
      </div>
      ...
      {clientsQuery.isLoading ? (
        ...
        <ClientListTable
          ...
          personLabel="Clients"
          onSelect={(userId) => router.push(`/consultant/reports/${userId}`)}
          search={search}
