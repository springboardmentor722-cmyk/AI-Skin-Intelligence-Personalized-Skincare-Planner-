...
const REQUIREMENTS = [
  {
    ...
    body: "Medical registration number, medical council, and years of practice.",
  },
  {
    icon: FileText,
    title: "Practice details",
    body: "Specializations, board certifications, and a short professional biography.",
  },
  {
    icon: BadgeCheck,
    title: "Verification documents",
    body: "Your medical license (and government ID, if applicable) — uploaded from your dashboard once your account is created.",
  },
];

// New UX — no wireframe exists for this (docs/AGENTS.md's "genuinely new" carve-out,
// Branch 5 of the Milestone 1 foundation expansion, mirroring Branch 4's consultant
// wizard shape). Reachable by a plain "user" account applying for the first time, or a
// "dermatologist" account whose application was rejected/needs more info and is
// resubmitting.
export default function DermatologistOnboardingIntroPage() {
  return (
      ...
      <div className="flex flex-col gap-10 text-center">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-on-surface-variant mx-auto max-w-xl font-sans text-lg">
            Tell us about your medical background. Our team reviews every application
            before your account unlocks patient-facing features.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Button
            ...
            nativeButton={false}
            render={
              <Link href="/dermatologist-onboarding/background">
                Start application
