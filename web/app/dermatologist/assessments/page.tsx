...
// Reuses the exact same GET /clients/me roster + ClientListTable as Patients,
// framed as an assessment worklist. Row click opens the assessment-history
// detail view, not the patient profile page.
export default function DermatologistAssessmentsPage() {
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-on-surface-variant mt-1 font-sans text-sm">
          Latest skin health score per assigned patient. Open a patient to see full assessment
      ...
      {clientsQuery.isLoading ? (
        ...
        <ClientListTable
          ...
          onSelect={(userId) => router.push(`/dermatologist/assessments/${userId}`)}
          search={search}
