...
// Same roster + ClientListTable as Patients/Assessments — pick a patient, then
// view their Skin Score trend, adherence, milestones, and weekly logs.
export default function DermatologistProgressPage() {
  ...
  const clientsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      if (error) throw new Error("Couldn't load patient progress.");
      return data;
    },
  });
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-on-surface-variant mt-1 font-sans text-sm">Monitor patient progress.</p>
      </div>
      ...
      {clientsQuery.isLoading ? (
        ...
        <ClientListTable
          ...
          onSelect={(userId) => router.push(`/dermatologist/progress/${userId}`)}
          search={search}
