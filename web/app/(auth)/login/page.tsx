        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-muted text-on-surface placeholder:text-on-surface-variant/60 focus:ring-secondary/40 w-full rounded-lg border-none py-2.5 pr-3 pl-10 font-sans text-sm focus:ring-2 focus:outline-none"
              {...register("email")}
            />
          </div>
          {errors.email && (
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="bg-muted text-on-surface placeholder:text-on-surface-variant/60 focus:ring-secondary/40 w-full rounded-lg border-none py-2.5 pr-10 pl-10 font-sans text-sm focus:ring-2 focus:outline-none"
              {...register("password")}
            />
            <button
              type="button"
